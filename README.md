...
`github.com/nuln/agent-secret-env` — Env Secret Provider plugin for [nuln/agent-core](https://github.com/nuln/agent-core).
...
|-------|-------|
| **Plugin Type** | `secret` |
| **Module** | `github.com/nuln/agent-secret-env` |
